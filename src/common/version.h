...
#define SCHAT_VERSION      "0.7.0.1230 Beta"
#define SCHAT_VERSION_RC   0,7,0,1230
...
static const int UpdateLevelQt   = 2009120201;
static const int UpdateLevelCore = 2009120201;
