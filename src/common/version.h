...
#define SCHAT_VERSION      "0.8.4.2264 Beta"
#define SCHAT_VERSION_RC   0,8,4,2264
...
static const int UpdateLevelQt   = 2012020500;
static const int UpdateLevelCore = 2012020500;
