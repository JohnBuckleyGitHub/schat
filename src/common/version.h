...
#define SCHAT_VERSION      "0.8.0.1390 Beta"
#define SCHAT_VERSION_RC   0,8,0,1390
...
static const int UpdateLevelQt   = 2011010100;
static const int UpdateLevelCore = 2011010100;
