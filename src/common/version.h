...
#define SCHAT_VERSION      "0.7.5.1361 Beta"
#define SCHAT_VERSION_RC   0,7,5,1361
...
static const int UpdateLevelQt   = 2010121400;
static const int UpdateLevelCore = 2010121400;
