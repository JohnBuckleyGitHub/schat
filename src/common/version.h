...
#define SCHAT_VERSION      "0.7.1.1250 Beta"
#define SCHAT_VERSION_RC   0,7,1,1250
...
static const int UpdateLevelQt   = 2010012000;
static const int UpdateLevelCore = 2010012000;
