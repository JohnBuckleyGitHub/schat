...
#define SCHAT_VERSION      "0.7.4.1348 Beta"
#define SCHAT_VERSION_RC   0,7,4,1348
...
static const int UpdateLevelQt   = 2010111400;
static const int UpdateLevelCore = 2010111400;
