...
#define SCHAT_VERSION      "0.8.1.1445 Beta"
#define SCHAT_VERSION_RC   0,8,1,1445
...
static const int UpdateLevelQt   = 2011031400;
static const int UpdateLevelCore = 2011031400;
