...
#define SCHAT_VERSION      "0.8.4.2277 Beta"
#define SCHAT_VERSION_RC   0,8,4,2277
...
static const int UpdateLevelQt   = 2012020900;
static const int UpdateLevelCore = 2012020900;
