...
#define SCHAT_VERSION      "0.7.1.1265 Beta"
#define SCHAT_VERSION_RC   0,7,1,1265
...
static const int UpdateLevelQt   = 2010012100;
static const int UpdateLevelCore = 2010020900;
