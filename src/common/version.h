...
#define SCHAT_VERSION      "0.8.3.2000 Beta"
#define SCHAT_VERSION_RC   0,8,3,2000
...
static const int UpdateLevelQt   = 2011121500;
static const int UpdateLevelCore = 2011121500;
