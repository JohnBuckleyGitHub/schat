...
#define SCHAT_VERSION      "0.8.4.2300 Beta"
#define SCHAT_VERSION_RC   0,8,4,2300
...
static const int UpdateLevelQt   = 2012020400;
static const int UpdateLevelCore = 2012020400;
