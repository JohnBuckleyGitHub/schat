...
#define SCHAT_VERSION      "0.4.0.841 TRUNK"
#define SCHAT_VERSION_RC   0,4,0,841
...
static const int UpdateLevelQt   = 2008112500;
static const int UpdateLevelCore = 2009010100;
