...
#define SCHAT_VERSION      "0.7.0.1104 TRUNK"
#define SCHAT_VERSION_RC   0,7,0,1104
...
static const int UpdateLevelQt   = 2009042400;
static const int UpdateLevelCore = 2009050201;
