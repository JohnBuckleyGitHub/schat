...
#define SCHAT_VERSION      "0.5.1.1026 TRUNK"
#define SCHAT_VERSION_RC   0,5,1,1026
...
static const int UpdateLevelQt   = 2009013101;
static const int UpdateLevelCore = 2009030300;
