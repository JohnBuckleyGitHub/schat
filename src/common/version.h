...
#define SCHAT_VERSION      "0.7.0.1128 TRUNK"
#define SCHAT_VERSION_RC   0,7,0,1128
...
static const int UpdateLevelQt   = 2009050400;
static const int UpdateLevelCore = 2009051500;
