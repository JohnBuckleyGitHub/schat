...
#define SCHAT_VERSION      "0.8.0.1376 Beta"
#define SCHAT_VERSION_RC   0,8,0,1376
...
static const int UpdateLevelQt   = 2010122600;
static const int UpdateLevelCore = 2010122600;
