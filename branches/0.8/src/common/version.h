...
#define SCHAT_VERSION      "0.8.1.1443 Beta"
#define SCHAT_VERSION_RC   0,8,1,1443
...
static const int UpdateLevelQt   = 2011021100;
static const int UpdateLevelCore = 2011021801;
