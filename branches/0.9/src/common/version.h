...
#define SCHAT_VERSION      "0.9.0.1460 Beta"
#define SCHAT_VERSION_RC   0,9,0,1460
...
static const int UpdateLevelQt   = 2011052100;
static const int UpdateLevelCore = 2011052100;
