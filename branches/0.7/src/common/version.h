...
#define SCHAT_VERSION      "0.7.3.1305 Beta"
#define SCHAT_VERSION_RC   0,7,3,1305
...
static const int UpdateLevelQt   = 2010070100;
static const int UpdateLevelCore = 2010070100;
