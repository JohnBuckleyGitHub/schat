...
#define SCHAT_VERSION      "0.7.5.1353 Beta"
#define SCHAT_VERSION_RC   0,7,5,1353
...
static const int UpdateLevelQt   = 2010111600;
static const int UpdateLevelCore = 2010120600;
