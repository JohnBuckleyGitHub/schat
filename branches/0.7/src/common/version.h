...
#define SCHAT_VERSION      "0.7.0.1229 Beta"
#define SCHAT_VERSION_RC   0,7,0,1229
...
static const int UpdateLevelQt   = 2009120200;
static const int UpdateLevelCore = 2009120200;
