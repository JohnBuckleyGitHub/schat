...
#define SCHAT_VERSION      "0.7.5.1362 Beta"
#define SCHAT_VERSION_RC   0,7,5,1362
...
static const int UpdateLevelQt   = 2010121500;
static const int UpdateLevelCore = 2010121500;
