...
#define SCHAT_VERSION      "0.7.3.1298 Beta"
#define SCHAT_VERSION_RC   0,7,3,1298
...
static const int UpdateLevelQt   = 2010061100;
static const int UpdateLevelCore = 2010062700;
