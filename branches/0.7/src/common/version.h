...
#define SCHAT_VERSION      "0.7.1.1251 Beta"
#define SCHAT_VERSION_RC   0,7,1,1251
...
static const int UpdateLevelQt   = 2010012001;
static const int UpdateLevelCore = 2010012001;
