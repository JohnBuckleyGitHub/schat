...
#define INFO_FEED_TEXT_KEY       QLatin1String("text")
#define INFO_FEED_TITLE_KEY      QLatin1String("title")
#define INFO_FEED_VISIBILITY_KEY QLatin1String("visibility")
#define INFO_FEED_VISIBILITY_REQ QLatin1String("info/visibility")
