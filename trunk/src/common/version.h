...
#define SCHAT_VERSION      "0.5.1.1041 TRUNK"
#define SCHAT_VERSION_RC   0,5,1,1041
...
static const int UpdateLevelQt   = 2009030901;
static const int UpdateLevelCore = 2009030901;
