...
#define SCHAT_VERSION      "0.5.0.924 TRUNK"
#define SCHAT_VERSION_RC   0,5,0,924
...
static const int UpdateLevelQt   = 2009013100;
static const int UpdateLevelCore = 2009013100;
