...
#define SCHAT_VERSION      "0.5.1.1039 TRUNK"
#define SCHAT_VERSION_RC   0,5,1,1039
...
static const int UpdateLevelQt   = 2009030801;
static const int UpdateLevelCore = 2009030801;
