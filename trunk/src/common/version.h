...
#define SCHAT_VERSION      "0.6.0.1053 TRUNK"
#define SCHAT_VERSION_RC   0,6,0,1053
...
static const int UpdateLevelQt   = 2009031200;
static const int UpdateLevelCore = 2009032300;
