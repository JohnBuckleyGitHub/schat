...
#define SCHAT_VERSION      "0.5.1.1040 TRUNK"
#define SCHAT_VERSION_RC   0,5,1,1040
...
static const int UpdateLevelQt   = 2009030900;
static const int UpdateLevelCore = 2009030900;
