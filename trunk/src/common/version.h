...
#define SCHAT_VERSION      "0.5.1.1038 TRUNK"
#define SCHAT_VERSION_RC   0,5,1,1038
...
static const int UpdateLevelQt   = 2009030400;
static const int UpdateLevelCore = 2009030800;
