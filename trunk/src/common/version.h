...
#define SCHAT_VERSION      "0.7.0.1186 TRUNK"
#define SCHAT_VERSION_RC   0,7,0,1186
...
static const int UpdateLevelQt   = 2009062700;
static const int UpdateLevelCore = 2009072101;
